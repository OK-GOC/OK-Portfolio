    ...
    <div className="sections">
      <div className="flex flex-col md:flex-row items-center gap-20">
        ...
        <div className="max-w-2xl order-1 md:order-2">
          ...
          <p className="text-[24px] md:text-[36px] font-semibold text-primary">
      ...
      <div className="body-text space-y-10 mt-10">
        <p>
          At OK Group of CompAt OK Group of Companies, we measure success not
          just in profits, but in the lasting impact we create for Myanmar and
          its people. Since our founding, we have remained committed to
          contributing to Myanmar's development by investing across key sectors
          - from infrastructure and energy to human resources, manufacturing,
          trade, and healthcare. Our journey began with a simple vision: to
          build a company that supports the country while setting standards in
          quality, trust, and innovation.anies, we measure success not just in
          profits, but in the lasting impact we create for Myanmar and its
          people. Since our founding, we have remained committed to contributing
          to Myanmar's development by investing across key sectors - from
          ...
          company that supports the country while setting standards in quality,
